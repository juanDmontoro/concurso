...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, toptitle=1mm, bottomrule=.15mm, breakable, opacitybacktitle=0.6, leftrule=.75mm, opacityback=0, colback=white, titlerule=0mm, rightrule=.15mm, arc=.35mm, left=2mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, title={Herramientas y Técnicas del Análisis de Datos}, colbacktitle=quarto-callout-note-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, toptitle=1mm, bottomrule=.15mm, breakable, opacitybacktitle=0.6, leftrule=.75mm, opacityback=0, colback=white, titlerule=0mm, rightrule=.15mm, arc=.35mm, left=2mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, title={El conjunto de datos de referencia}, colbacktitle=quarto-callout-note-color!10!white]
...
\begin{column}{0.65\linewidth}
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, toptitle=1mm, bottomrule=.15mm, breakable, opacitybacktitle=0.6, leftrule=.75mm, opacityback=0, colback=white, titlerule=0mm, rightrule=.15mm, arc=.35mm, left=2mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, title={Experimentos aleatorios controlados: el patrón de referencia}, colbacktitle=quarto-callout-note-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, toptitle=1mm, bottomrule=.15mm, breakable, opacitybacktitle=0.6, leftrule=.75mm, opacityback=0, colback=white, titlerule=0mm, rightrule=.15mm, arc=.35mm, left=2mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, title={Proximidad estética: un aspecto recurrente en la literatura}, colbacktitle=quarto-callout-note-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, toptitle=1mm, bottomrule=.15mm, breakable, opacitybacktitle=0.6, leftrule=.75mm, opacityback=0, colback=white, titlerule=0mm, rightrule=.15mm, arc=.35mm, left=2mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, title={Por qué etiquetas y no géneros de plataforma}, colbacktitle=quarto-callout-note-color!10!white]
...
\tightlist
\item
  \textbf{Resultado sensible al rol}: el evento es una colaboración del
  par como artista \textbf{principal} e \textbf{invitado}
  (\emph{lead--feature}) en una pista del corpus lanzada en \(t\).
\item
  \textbf{Formación}: exige inexistencia de lazos previos; las
  repeticiones se estudian aparte (1.811 eventos agregados frente a
  1.064 de formación).
\item
  \textbf{Pares invitado--invitado}: no son eventos del resultado
  principal ni se codifican como negativos.
\item
  \textbf{Un evento raro}: 1.064 formaciones entre 3.756.411 díadas-año
  (28,3 por cada 100.000).
\end{itemize}

\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, toptitle=1mm, bottomrule=.15mm, breakable, opacitybacktitle=0.6, leftrule=.75mm, opacityback=0, colback=white, titlerule=0mm, rightrule=.15mm, arc=.35mm, left=2mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, title={Definición de la respuesta a modelizar}, colbacktitle=quarto-callout-note-color!10!white]

Para un par \((i,j)\) del conjunto de riesgo, \(y^F_{ij,t}=1\) si en
\(t\) hay una colaboración principal--invitado en una pista del corpus y
no existe ningún lazo previo entre ambos.

\end{tcolorbox}

\note{Esta diapositiva define el resultado, que se etiqueta después de
construir el conjunto de riesgo. Primero identificamos colaboraciones
principal--invitado en pistas del corpus lanzadas en \(t\); para la
formación exigimos además ausencia de cualquier lazo previo. Los pares
invitado--invitado no son eventos de este resultado ni se codifican como
negativos, aunque sí cuentan en la red y en el historial de vínculos.
Tras aplicar elegibilidad y filtros de estimación quedan 1.064 eventos
en 3.756.411 díadas-año: 28,3 por cada 100.000. La rareza condiciona el
...
\tightlist
\item
  \textbf{Todos los pares elegibles}: se incluyen todas las parejas no
  ordenadas de artistas elegibles; no se muestrean negativos.
\item
  \textbf{Quién es elegible (aw3)}: cada artista tenía antes de \(t\)
  algún lanzamiento incluido en el corpus y al menos uno fechado entre
  \(t-3\) y \(t-1\). Si uno no cumple, la colaboración observada queda
  fuera.
\item
  \textbf{Cobertura (2016--2024)}: aw3 excluye 1.457 de 2.481 primeras
  colaboraciones \emph{lead--feature} observadas (58,7\%); aw0 elimina
  la ventana, pero mantiene la entrada antes de \(t\) y todavía excluye
  1.374 (55,4\%). Recupera solo 83 casos (3,35 pp); aw5 se estima
  aparte.
\item
  \textbf{Muestra estimada (2015--2024)}: 3.756.411 díadas-año, 1.064
  formaciones y 2.256 artistas.
\end{itemize}

\note{El conjunto se fija con información hasta \(t-1\), antes de
etiquetar el resultado. Se generan todos los pares elegibles, sin
muestrear ceros. Si un artista no cumple, la colaboración observada
queda fuera del panel, no se convierte en cero. El reloj es el año de
lanzamiento de una pista del corpus.

En 2016--2024, aw3 excluye 1.457 de 2.481 primeras colaboraciones
\emph{lead--feature} (58,7\%). aw0 elimina la ventana, pero mantiene la
entrada anterior a \(t\): todavía excluye 1.374 (55,4\%) y recupera solo
83. La proporción anual de participantes que debuta en \(t\) oscila
entre 41,3\% y 53,8\%.}
\end{frame}
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, toptitle=1mm, bottomrule=.15mm, breakable, opacitybacktitle=0.6, leftrule=.75mm, opacityback=0, colback=white, titlerule=0mm, rightrule=.15mm, arc=.35mm, left=2mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, title={¿Por qué no un ERGM? \(\to\) Almquist y Butts (2014)}, colbacktitle=quarto-callout-note-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, toptitle=1mm, bottomrule=.15mm, breakable, opacitybacktitle=0.6, leftrule=.75mm, opacityback=0, colback=white, titlerule=0mm, rightrule=.15mm, arc=.35mm, left=2mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, title={Nota}, colbacktitle=quarto-callout-note-color!10!white]
