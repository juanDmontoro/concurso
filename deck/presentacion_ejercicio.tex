...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, arc=.35mm, bottomrule=.15mm, rightrule=.15mm, toprule=.15mm, breakable, leftrule=.75mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, opacitybacktitle=0.6, coltitle=black, title={Herramientas y Técnicas del Análisis de Datos}, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, arc=.35mm, bottomrule=.15mm, rightrule=.15mm, toprule=.15mm, breakable, leftrule=.75mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, opacitybacktitle=0.6, coltitle=black, title={El conjunto de datos de referencia}, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
\begin{column}{0.65\linewidth}
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, arc=.35mm, bottomrule=.15mm, rightrule=.15mm, toprule=.15mm, breakable, leftrule=.75mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, opacitybacktitle=0.6, coltitle=black, title={Experimentos aleatorios controlados: el patrón de referencia}, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
\(\hat{g}\) selecciona controles por su capacidad de predecir \(y\), no
\(D\) \(\to\) \textbf{sesgo de regularización}.

Mismos datos para entrenar y predecir \(\to\) \textbf{sesgo por
sobreajuste}.
...
\tightlist
\item
  Aprender \(\hat{g}\) \textbf{y} \(\hat{m}\); residualizar respuesta y
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{presentacion_ejercicio_files/mediabag/figures/fig_esquema_dml.pdf}
\end{column}
\end{columns}

\note{La aplicación ingenua del aprendizaje automático a este problema
consiste en aprender un modelo flexible para \(g\), residualizar la
respuesta y regresar ese residuo sobre el tratamiento. Falla por dos
motivos. Los modelos de aprendizaje automático regularizan y seleccionan
las variables por su capacidad para predecir la respuesta: un control
poco correlacionado con \(y\) pero relevante para explicar \(D\) queda
atenuado o fuera del modelo, y la segunda etapa atribuye a \(\tau\)
parte de su relación con el tratamiento. Es un sesgo de variable omitida
que aquí se denomina sesgo de regularización. Además, si se entrena y se
predice sobre las mismas observaciones, los residuos absorben parte del
efecto causal y la varianza residual del tratamiento se distorsiona: es
el sesgo por sobreajuste.

Double Machine Learning corrige ambos. La ortogonalización residualiza
también el tratamiento con la función auxiliar \(m\) que ya aparecía en
el grafo y regresa residuos sobre residuos, a la Frisch--Waugh--Lovell.
El cross-fitting separa las observaciones con las que se entrena de
aquellas sobre las que se predice. La combinación produce un estimador
raíz de \(n\) consistente con inferencia válida, que los estudiantes
implementan con DoubleML como un estimador en dos etapas.}
\end{frame}
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, arc=.35mm, bottomrule=.15mm, rightrule=.15mm, toprule=.15mm, breakable, leftrule=.75mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, opacitybacktitle=0.6, coltitle=black, title={Proximidad estética: un aspecto recurrente en la literatura}, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, arc=.35mm, bottomrule=.15mm, rightrule=.15mm, toprule=.15mm, breakable, leftrule=.75mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, opacitybacktitle=0.6, coltitle=black, title={Por qué etiquetas y no géneros de plataforma}, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, arc=.35mm, bottomrule=.15mm, rightrule=.15mm, toprule=.15mm, breakable, leftrule=.75mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, opacitybacktitle=0.6, coltitle=black, title={Definición de la respuesta a modelizar}, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, arc=.35mm, bottomrule=.15mm, rightrule=.15mm, toprule=.15mm, breakable, leftrule=.75mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, opacitybacktitle=0.6, coltitle=black, title={¿Por qué no un ERGM? \(\to\) Almquist y Butts (2014)}, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, arc=.35mm, bottomrule=.15mm, rightrule=.15mm, toprule=.15mm, breakable, leftrule=.75mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, opacitybacktitle=0.6, coltitle=black, title={Nota}, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
