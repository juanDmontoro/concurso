...
\begin{frame}{Trayectoria académica}
\phantomsection\label{trayectoria-acaduxe9mica}
~
...
Cuadrado-García María José Miquel-Romero María Caballer-Tarazona María
Luisa Palma-Martos \\ \lightrowrule
\end{longtable}

\note{La tabla ordena las líneas de investigación, los trabajos
representativos y los principales coautores.
...
La tercera línea, desde 2008, se orienta a la economía de la cultura e
...
trabajos de esta línea se realizan junto a los profesores Manuel
Cuadrado-García y María José Miquel-Romero y más recientemente las
profesoras María Caballer-Tarazona y María Luisa Palma-Martos, y en
ellos se exploran diversos aspectos de la participación cultural, las
industrias creativas y el big data, cuyos resultados se publican en
revistas como el Journal of Cultural Economics, Poetics o Empirical
Economics.}
\end{frame}
...
citas (cerca del setenta por ciento de las citas se ha recibido desde
...
Cultural Economics}, 2011 & JCR \textbf{Q2} (Economics) & 45 · 54 ·
124 \\ \lightrowrule
...
\emph{Tourism Economics}, 2021 & JCR \textbf{Q1} (Economics) & 8 · 8 ·
12 \\ \lightrowrule
...
\bottomrule\noalign{}
\endlastfoot
Sociedad Española de Radiodifusión (SER) & Organización y programación
de un evento de música, cultura y ocio & 2012--13 & equipo \\ \lightrowrule
FECEMAC-CV & Indicadores de rendimiento y satisfacción en gestión de la
educación musical & 2014--15 & equipo \\ \lightrowrule
Olympia Metropolitana & Actividades del centenario del Teatro Olympia &
2015--16 & equipo \\ \lightrowrule
...
La diapositiva muestra una selección de diez contratos y convenios con
el tejido cultural, desde el periodo del sexenio hasta hoy. En total son
dieciséis desde 2012, seis de ellos como investigador principal, una
actividad que está reconocida con el sexenio de transferencia del
periodo 2012--2017.

En un camino de ida y vuelta, parte de esa transferencia se ha traducido
a su vez en resultados de investigación.}
\end{frame}
...
de Gran Canaria) & en curso & JCR en revisión \\ \lightrowrule
...
internacional. La de Desamparados Lluch Tormos, de 2017, sobre
segmentación y exhibición cinematográfica recibió además el Premio
...
tendencia ascendente, se mantiene por encima de cuatro sobre cinco desde
2017 y alcanza un máximo de 4,78 en el curso 2023--2024.}
\end{frame}
...
\textbf{17 cargos y tareas de gestión}, principalmente en
...
\textbf{Evaluación científica} & \textbf{36 revisiones verificadas} para
...
\item
  ...
  y seis revisiones verificadas para quince journals, que me ubica en el
...
\note{Cierro con una síntesis del currículum. En la producción
científica, más allá del volumen, su impacto: tres de cada cuatro
artículos publicados en revistas del cuartil superior del área; 68\% de
las citas acumuladas a partir de 2021, con un impacto normalizado en
2025 un 32\% por encima de lo esperado en el campo (situación que se
repite en 5 de los últimos diez años); uno de cada seis artículos se
ubica en el decil superior por citas de su categoría (WoS). Una
investigación reconocida con cuatro sexenios de investigación en el
campo de Economía.

El conjunto de méritos refleja una trayectoria consolidada en liderazgo,
internacionalización, docencia de excelencia y asunción continuada de
responsabilidades académicas a lo largo de casi tres décadas.}
\end{frame}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, breakable, toprule=.15mm, coltitle=black, colback=white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6, opacityback=0, title={Herramientas y Técnicas del Análisis de Datos}, titlerule=0mm, bottomrule=.15mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, breakable, toprule=.15mm, coltitle=black, colback=white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6, opacityback=0, title={El conjunto de datos de referencia}, titlerule=0mm, bottomrule=.15mm, left=2mm]
...
mayor parte de la nota tiene que salir de ahí. No obstante el examen
garantiza que cada estudiante domina los conceptos evita que la continua
...
\textbf{Proyecto reproducible (15\%)} & Repositorio, entorno, ejecución
...
\textbf{Interpretación y comunicación (20\%)} & Memoria, figuras,
...
\begin{column}{0.65\linewidth}
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, breakable, toprule=.15mm, coltitle=black, colback=white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6, opacityback=0, title={Experimentos aleatorios controlados: el patrón de referencia}, titlerule=0mm, bottomrule=.15mm, left=2mm]
...
\note{\textbf{Empezamos con una pregunta práctica: ante el riesgo de
abandono, ¿a qué clientes dirigir una campaña de retención?}

Se ilustra en el aula con el experimento reportado en Ascarza (2018). Un
...
los clientes según probabilidad de abandono y sensibilidad a la
intervención: seleccionar por sensibilidad a la intervención reduce más
el abandono que seleccionar por riesgo.
...
identificar sesgos, aplicar DML como un estimador en dos etapas (una
predictiva y otra inferencial) y valorar los supuestos y por tanto
...
\begin{frame}{Resumen de la propuesta en cuatro ideas}
\phantomsection\label{resumen-de-la-propuesta-en-cuatro-ideas}
~
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Colaboración} & Dos artistas graban juntos una canción, el
fenómeno \emph{feat.}: \textbf{Bad Bunny y J Balvin}, \textbf{Taylor
Swift y Kendrick Lamar}. Hoy es una práctica frecuente. \\ \lightrowrule
...
\textbf{Hipótesis} & Estar cerca facilita el encaje: \textbf{Bad Bunny}
y \textbf{J Balvin} han grabado juntos en varias ocasiones. Pero también
colaboran artistas lejanos: \textbf{Taylor Swift} y \textbf{Kendrick
Lamar}. ¿Hay un punto a partir del cual parecerse más ya no suma, o
incluso resta? \\ \lightrowrule
\end{longtable}

\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, breakable, toprule=.15mm, coltitle=black, colback=white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6, opacityback=0, title={Variables adicionales}, titlerule=0mm, bottomrule=.15mm, left=2mm]
...
\item
  La colaboración implica una decisión: con quien; nos preguntamos qué
  distingue a los pares que llegan a trabajar juntos.\\
\item
  Para responderla cada artista se ubica en un espacio construido a
  partir de las etiquetas que la audiencia utiliza en redes para
  describir su obra. Encontramos p.e. que el público usa un vocabulario
  similar para etiquetar a Bad Bunny y J Balvin (proximos), mientras que
  Taylor Swift y Kendrick Lamar apenas comparten términos (distantes).
\item
...
\vspace{0.8em}
{\large \mbox{\color{mDarkTeal}\bfseries Motivación y contexto}~· \mbox{\color{black!40}Datos y diseño}~· \mbox{\color{black!40}Resultados}~· \mbox{\color{black!40}Conclusiones}\par}}
\end{frame}

\section{Motivación y contexto}\label{motivaciuxf3n-y-contexto}
...
\begin{frame}{Colaboración en la industria de la música}
\phantomsection\label{colaboraciuxf3n-en-la-industria-de-la-muxfasica}
~
...
sitúa en torno al 40\%: la colaboración ha pasado de ser una anomalía a
una práctica frecuente. La evolución sugiere un cambio estructural que
emerge en paralelo a la digitalización de la música y se asienta con la
implantación de un modelo de negocio basado en el acceso, y no en la
propiedad: el streaming.
...
\gdef\roadmapcontent{{\scriptsize \mbox{\color{black!40}Parte 1 · Currículum}\quad \mbox{\color{black!40}Parte 2 · Propuesta docente}\quad \mbox{\color{mDarkTeal}\bfseries Parte 3 · Propuesta investigadora: Creative collaborations}\par}
\vspace{0.8em}
{\large \mbox{\color{black!40}Motivación y contexto}~· \mbox{\color{mDarkTeal}\bfseries Datos y diseño}~· \mbox{\color{black!40}Resultados}~· \mbox{\color{black!40}Conclusiones}\par}}
\end{frame}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, breakable, toprule=.15mm, coltitle=black, colback=white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6, opacityback=0, title={Por qué etiquetas y no géneros de plataforma}, titlerule=0mm, bottomrule=.15mm, left=2mm]
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{presentacion_ejercicio_files/mediabag/figures/fig_network_aimac_wide.pdf}}
\end{center}
...
\item
  ...
  como negativos). Asimismo, cualquier posible colaboración
  \textbf{principal-invitado} posterior no es un evento de
  \textbf{formación}.
\end{itemize}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, breakable, toprule=.15mm, coltitle=black, colback=white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6, opacityback=0, title={Evento raro}, titlerule=0mm, bottomrule=.15mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, breakable, toprule=.15mm, coltitle=black, colback=white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6, opacityback=0, title={¿Por qué no un ERGM?}, titlerule=0mm, bottomrule=.15mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, breakable, toprule=.15mm, coltitle=black, colback=white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6, opacityback=0, title={Nota}, titlerule=0mm, bottomrule=.15mm, left=2mm]
...
\gdef\roadmapcontent{{\scriptsize \mbox{\color{black!40}Parte 1 · Currículum}\quad \mbox{\color{black!40}Parte 2 · Propuesta docente}\quad \mbox{\color{mDarkTeal}\bfseries Parte 3 · Propuesta investigadora: Creative collaborations}\par}
\vspace{0.8em}
{\large \mbox{\color{black!40}Motivación y contexto}~· \mbox{\color{black!40}Datos y diseño}~· \mbox{\color{mDarkTeal}\bfseries Resultados}~· \mbox{\color{black!40}Conclusiones}\par}
\vspace{0.2em}
\hspace{1.5em}{\normalsize \mbox{\color{mDarkTeal}\bfseries Modelo base}~· \mbox{\color{black!40}Predicción}~· \mbox{\color{black!40}Sensibilidad}\par}}
\end{frame}

\section{Resultados · Modelo base}\label{resultados-modelo-base}
...
\item
  ...
  prespecificada.\\
\item
  \textbf{Reversión de signo}: localizar un máximo y estimar la
  pendiente en mitades separadas de la muestra. \textbf{Criterio
...
\begin{longtable}[]{@{}lrl@{}}
\toprule\noalign{}
Resultado & Media & {[}2,5\%, 97,5\%{]} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
\(b\) & 0,670 & {[}0,373; 0,763{]} \\ \lightrowrule
\(D_{\mathrm{pre}}\) & 2,132 & {[}1,177; 3,206{]} \\ \lightrowrule
\(\beta_{\mathrm{post}}\) & 2,496 & {[}-2,763; 8,586{]} \\ \lightrowrule
\end{longtable}

\textbf{Contraste de reversión}: Subida anterior y pendiente posterior
imprecisa. No se confirma la reversión
\end{column}
...
Por otro lado el contraste identifica el ascenso previo si bien, el
intervalo por bootstrap de la pendiente posterior incluye cero.
...
{\large \mbox{\color{black!40}Motivación y contexto}~· \mbox{\color{black!40}Datos y diseño}~· \mbox{\color{mDarkTeal}\bfseries Resultados}~· \mbox{\color{black!40}Conclusiones}\par}
\vspace{0.2em}
\hspace{1.5em}{\normalsize \mbox{\color{black!40}Modelo base}~· \mbox{\color{mDarkTeal}\bfseries Predicción}~· \mbox{\color{black!40}Sensibilidad}\par}}
\end{frame}
...
{\large \mbox{\color{black!40}Motivación y contexto}~· \mbox{\color{black!40}Datos y diseño}~· \mbox{\color{mDarkTeal}\bfseries Resultados}~· \mbox{\color{black!40}Conclusiones}\par}
\vspace{0.2em}
\hspace{1.5em}{\normalsize \mbox{\color{black!40}Modelo base}~· \mbox{\color{black!40}Predicción}~· \mbox{\color{mDarkTeal}\bfseries Sensibilidad}\par}}
\end{frame}
...
\gdef\roadmapcontent{{\scriptsize \mbox{\color{black!40}Parte 1 · Currículum}\quad \mbox{\color{black!40}Parte 2 · Propuesta docente}\quad \mbox{\color{mDarkTeal}\bfseries Parte 3 · Propuesta investigadora: Creative collaborations}\par}
\vspace{0.8em}
{\large \mbox{\color{black!40}Motivación y contexto}~· \mbox{\color{black!40}Datos y diseño}~· \mbox{\color{black!40}Resultados}~· \mbox{\color{mDarkTeal}\bfseries Conclusiones}\par}}
\end{frame}
...
El contraste flexible evita atribuir una distancia óptima a lo que
podría depender de la especificación del modelo.

Un resultado generalizable: Estudiar conjuntamente emparejamiento y
rendimiento para analizar la compatibilidad en formación y en
resultados.}
\end{frame}
