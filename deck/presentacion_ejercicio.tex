...
\note{Cierro con una síntesis del currículum en cifras. En investigación
y transferencia: cuarenta y seis artículos, treinta y seis en revistas
indexadas; veintinueve capítulos; ciento dieciocho comunicaciones,
noventa y dos internacionales; siete proyectos competitivos; dieciséis
contratos con el sector cultural, seis como investigador principal; seis
estancias y cuatro tesis dirigidas.

En dirección y liderazgo: diecisiete cargos de gestión, concentrados en
internacionalización; doce conferencias por invitación; y treinta y
cinco revisiones verificadas, en el percentil noventa y uno.

En docencia: trece titulaciones en siete centros, la mitad de la
docencia en inglés y la calificación de excelente en DOCENTIA.

La banda inferior muestra la continuidad de la actividad evaluada:
cuatro sexenios de investigación, uno de transferencia y cinco
quinquenios, junto a las responsabilidades de dirección, desde la tesis
doctoral en 1996 hasta la acreditación a catedrático en 2024.}
\end{frame}
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, titlerule=0mm, bottomrule=.15mm, coltitle=black, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, colback=white, arc=.35mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, breakable, title={Herramientas y Técnicas del Análisis de Datos}, toptitle=1mm, rightrule=.15mm, toprule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, titlerule=0mm, bottomrule=.15mm, coltitle=black, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, colback=white, arc=.35mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, breakable, title={El conjunto de datos de referencia}, toptitle=1mm, rightrule=.15mm, toprule=.15mm, opacityback=0]
...
\begin{column}{0.65\linewidth}
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, titlerule=0mm, bottomrule=.15mm, coltitle=black, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, colback=white, arc=.35mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, breakable, title={Experimentos aleatorios controlados: el patrón de referencia}, toptitle=1mm, rightrule=.15mm, toprule=.15mm, opacityback=0]
...
de negocio; para eso hay que estimar el efecto causal. La cuestión
siguiente es cómo hacerlo sin experimento, con datos observacionales.}
\end{frame}
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, titlerule=0mm, bottomrule=.15mm, coltitle=black, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, colback=white, arc=.35mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, breakable, title={Y no solo la dimensión estética}, toptitle=1mm, rightrule=.15mm, toprule=.15mm, opacityback=0]
...
\note{Antes del esquema, la propuesta en cuatro ideas. Colaborar es
grabar juntos una canción, como Bad Bunny y J Balvin o Taylor Swift y
Kendrick Lamar, y hoy es práctica habitual.

Pero cada artista podría colaborar con muchos y solo lo hace con pocos:
la pregunta es qué distingue a los pares que llegan a trabajar juntos.

Para responderla sitúo a cada artista en un mapa construido a partir de
la descripción de su público. Bad Bunny y J Balvin reciben un
vocabulario casi idéntico y están cerca; Bad Bunny y Ed Sheeran apenas
comparten palabras y están lejos.

La hipótesis central es que estar cerca ayuda: Bad Bunny y J Balvin han
grabado juntos varias veces. Pero Taylor Swift y Kendrick Lamar, que
están lejos, también lo han hecho. La cuestión abierta es si hay un
punto en que parecerse más ya no aporta. Todo ello junto a la red de
contactos, la escena y la trayectoria.}
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, titlerule=0mm, bottomrule=.15mm, coltitle=black, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, colback=white, arc=.35mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, breakable, title={Por qué etiquetas y no géneros de plataforma}, toptitle=1mm, rightrule=.15mm, toprule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, titlerule=0mm, bottomrule=.15mm, coltitle=black, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, colback=white, arc=.35mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, breakable, title={Evento raro}, toptitle=1mm, rightrule=.15mm, toprule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, titlerule=0mm, bottomrule=.15mm, coltitle=black, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, colback=white, arc=.35mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, breakable, title={¿Por qué no un ERGM?}, toptitle=1mm, rightrule=.15mm, toprule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, titlerule=0mm, bottomrule=.15mm, coltitle=black, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, colback=white, arc=.35mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, breakable, title={Nota}, toptitle=1mm, rightrule=.15mm, toprule=.15mm, opacityback=0]
...
\note{La figura compara las asociaciones del modelo completo para
variables seleccionadas. Cada punto es el cambio en la ratio de odds
ante un aumento de una desviación estándar en las variables continuas, o
presencia frente a ausencia en las binarias. ¿Qué perfil de par dibuja
cada bloque?
...
\note{SPLINE: la curva suavizada muestra predicciones del logit con
spline con un crecimiento marcado de la tasa de formación desde niveles
bajos de similitud y una moderación posterior. PUNTOS: representan tasas
ajustadas por intervalos; no hay descenso claro y mayor imprecisión en
la parte alta.

El contraste identifica un pendiente positiva antes del punto de ruptura
con un intervalo que excluye cero. Después, la pendiente es positiva,
pero su intervalo incluye cero.
