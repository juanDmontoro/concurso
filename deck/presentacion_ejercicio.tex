...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, left=2mm, opacitybacktitle=0.6, breakable, arc=.35mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, colback=white, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, title={Herramientas y Técnicas del Análisis de Datos}, rightrule=.15mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, left=2mm, opacitybacktitle=0.6, breakable, arc=.35mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, colback=white, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, title={El conjunto de datos de referencia}, rightrule=.15mm, bottomrule=.15mm]
...
final que conecta predicción y explicación.
...
\begin{column}{0.65\linewidth}
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, left=2mm, opacitybacktitle=0.6, breakable, arc=.35mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, colback=white, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, title={Experimentos aleatorios controlados: el patrón de referencia}, rightrule=.15mm, bottomrule=.15mm]
...
Frecuentemente trabajamos con datos observacionales: entonces hemos de
considerar la posibilidad de confusión si la selección al tratamiento se
ve afectada las variables \(X\), de ahí que incorporemos este proceso a
...
respuesta y regresar ese residuo sobre el tratamiento.

La aproximación falla por dos motivos:\\
1. Los modelos de aprendizaje automático regularizan y seleccionan las
variables por su capacidad para predecir la respuesta: un control poco
correlacionado con \(y\) pero relevante para explicar \(D\) queda
...
que aquí se denomina \textbf{sesgo de regularización}.\\
2. Además, si se entrena y se predice sobre las mismas observaciones,
los residuos absorben parte del efecto causal y la varianza residual del
tratamiento se distorsiona: es el \textbf{sesgo por sobreajuste}.
...
\tightlist
\item
  La ortogonalización residualiza también el tratamiento con las
  predicciones de la función auxiliar \(m\).\\
\item
  El cross-fitting separa las observaciones con las que se entrena de
  aquellas sobre las que se predice.
\item
  La combinación produce un estimador raíz de \(n\) consistente con
  inferencia válida, que los estudiantes implementan con DoubleML como
  un estimador en dos etapas.
\end{itemize}}
\end{frame}
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, left=2mm, opacitybacktitle=0.6, breakable, arc=.35mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, colback=white, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, title={Proximidad estética: un aspecto recurrente en la literatura}, rightrule=.15mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, left=2mm, opacitybacktitle=0.6, breakable, arc=.35mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, colback=white, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, title={Por qué etiquetas y no géneros de plataforma}, rightrule=.15mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, left=2mm, opacitybacktitle=0.6, breakable, arc=.35mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, colback=white, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, title={Definición de la respuesta a modelizar}, rightrule=.15mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, left=2mm, opacitybacktitle=0.6, breakable, arc=.35mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, colback=white, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, title={¿Por qué no un ERGM? \(\to\) Almquist y Butts (2014)}, rightrule=.15mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, left=2mm, opacitybacktitle=0.6, breakable, arc=.35mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, colback=white, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, title={Nota}, rightrule=.15mm, bottomrule=.15mm]
