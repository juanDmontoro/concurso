...
\begin{tcolorbox}[enhanced jigsaw, title={Herramientas y Técnicas del Análisis de Datos}, toptitle=1mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, opacityback=0, coltitle=black, breakable, toprule=.15mm, leftrule=.75mm, bottomtitle=1mm, titlerule=0mm, arc=.35mm, rightrule=.15mm, colback=white, left=2mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={El conjunto de datos de referencia}, toptitle=1mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, opacityback=0, coltitle=black, breakable, toprule=.15mm, leftrule=.75mm, bottomtitle=1mm, titlerule=0mm, arc=.35mm, rightrule=.15mm, colback=white, left=2mm, bottomrule=.15mm]
...
\begin{column}{0.65\linewidth}
\begin{tcolorbox}[enhanced jigsaw, title={Experimentos aleatorios controlados: el patrón de referencia}, toptitle=1mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, opacityback=0, coltitle=black, breakable, toprule=.15mm, leftrule=.75mm, bottomtitle=1mm, titlerule=0mm, arc=.35mm, rightrule=.15mm, colback=white, left=2mm, bottomrule=.15mm]
...
cultural. Más concretamente, y la pregunta que se formula es qué
distingue a dos artistas que llegan a trabajar juntos de los muchos
pares que podrían haberlo hecho. Cierro el ejercicio presentando la
propuesta de investigación \emph{Creative Collaborations}, cuyo objeto
es el análisis de los factores asociados a la formación de
colaboraciones en la producción cultural. Más concretamente, la pregunta
que se formula es qué distingue a dos artistas que llegan a trabajar
juntos de los muchos pares que podrían haberlo hecho.}
...
\tightlist
\item
  \textbf{Motivación y pregunta económica}: selección de socios y el rol
  de la compatibilidad estética.
\item
  \textbf{Datos y diseño}: cómo observar colaboraciones y oportunidades.
\item
  \textbf{Resultados}: forma de la asociación, predicción y
  sensibilidad.
\item
  \textbf{Conclusiones}: aportación, límites y programa de
  investigación.
\end{itemize}
...
\note{La contribución combina una pregunta sobre formación de
...
\begin{tcolorbox}[enhanced jigsaw, title={Por qué etiquetas y no géneros de plataforma}, toptitle=1mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, opacityback=0, coltitle=black, breakable, toprule=.15mm, leftrule=.75mm, bottomtitle=1mm, titlerule=0mm, arc=.35mm, rightrule=.15mm, colback=white, left=2mm, bottomrule=.15mm]
...
\tightlist
\item
  Subgrafo del \textbf{5\% de artistas con mayor grado} en la red
  acumulada a 2024.
\item
...
La figura ilustra por qué \textbf{afinidad cultural y cercanía
relacional} deben medirse por separado.
...
\begin{tcolorbox}[enhanced jigsaw, title={Evento raro}, toptitle=1mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, opacityback=0, coltitle=black, breakable, toprule=.15mm, leftrule=.75mm, bottomtitle=1mm, titlerule=0mm, arc=.35mm, rightrule=.15mm, colback=white, left=2mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={¿Por qué no un ERGM?}, toptitle=1mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, opacityback=0, coltitle=black, breakable, toprule=.15mm, leftrule=.75mm, bottomtitle=1mm, titlerule=0mm, arc=.35mm, rightrule=.15mm, colback=white, left=2mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={Nota}, toptitle=1mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, opacityback=0, coltitle=black, breakable, toprule=.15mm, leftrule=.75mm, bottomtitle=1mm, titlerule=0mm, arc=.35mm, rightrule=.15mm, colback=white, left=2mm, bottomrule=.15mm]
...
\note{La figura compara asociaciones para variables seleccionadas.
Muestra el cambio en ratio de odds ante un incremento de una desviación
estándar en variables continuas y presencia frente a ausencia en
binarias.

En la red, la posición importa: mayor grado medio y proximidad geodésica
presentan asociaciones positivas, mientras que la diferencia de grado es
negativa. Los pares más conectados y menos asimétricos se distinguen de
otros pares elegibles. El índice de Jaccard muestra la dicotomía entre
significación estadística y sustantiva.

En la posición estética, la similitud del par, con término lineal
positivo y cuadrático negativo, dibujan un óptimo interior. Además, una
mayor similitud media al centroide se asocia con menor formación (si
bien la asimetría en los miembros del par aumenta la formación).

Compartir escena y sello muestran asociación positiva. Po otro lado, la
actividad media y su asimetría, con signos opuestos asocian
\textbf{pares activos y similares con una mayor probabilidad de
formación}. Una exposición prolongada sin colaboración presenta una
asociación negativa que puede capturar oportunidades no realizadas o
...
\note{La forma cuadrática de la similitud estética sitúa un máximo
implícito en 0,64, que se ubica en el percentil 95 de la similitud
observada: una zona con pocos eventos. En este caso la forma estimada es
compatible tanto con un crecimiento que se estabiliza como con un
descenso que, dada la escasez de información, los datos no permiten
identificar con precisión.

Para ver que hipótesis apoyan los datos, se utiliza:\\
1. Un enfoque exploratorio (discretizando la similitud y ajustando un
spline flexible).\\
2. Una prueba prespecificada con división de la muestra: utilizamos una
mitad para localizar el posible máximo y la otra para estimar las
pendientes a ambos lados. Solo confirmamos un máximo interior si la
pendiente es positiva antes del punto y negativa después. El
procedimiento se validó previamente mediante simulaciones.}
\end{frame}
...
del logit por tramos, con intervalos de confianza diádicos.
\end{column}
\end{columns}

\note{El spline muestra un crecimiento marcado de la tasa de formación
desde niveles bajos de similitud y una moderación posterior. Los puntos
resumen las tasas por intervalos de similitud que no muestran un
descenso claro a niveles altos (sí una mayor imprecisión).

El contraste de reversión muestra antes del punto de ruptura una
pendiente es positiva (intervalo de confianza excluye cero). Tras este,
la pendiente es positiva, pero el intervalo es amplio y abarca
pendientes negativas, nulas y positivas.

\textbf{En consecuencia, no se confirma el patrón de subida y caída
requerido para identificar un máximo interior; los resultados son
compatibles con una estabilización del crecimiento.}}
\end{frame}
...
Este ejercicio muestra estabilidad de estimaciones puntuales: La escasa
diferencia entre el logit convencional y el modelo de Firth no aporta
evidencia de un sesgo relevante asociado a la rareza del evento.}
\end{frame}
...
analizarse en una etapa concreta. Aunque la literatura ha identificado
una distancia óptima entre artistas para el éxito de sus colaboraciones,
esta no tiene por qué coincidir con la que favorece su formación.
Estudiar conjuntamente el emparejamiento y el rendimiento posterior
permitiría relacionar la compatibilidad para formar el equipo con la
complementariedad necesaria para obtener buenos resultados.}
\end{frame}
...
completamente su concentración. Este desajuste puede reflejar
heterogeneidad, dependencia o aspectos del procedimiento de simulación,
aunque no identifica una causa concreta ni demuestra sesgo en los
coeficientes. Su diagnóstico continua junto con las extensiones
sustantivas.}
\end{frame}
