...
| Línea | Trabajos representativos | Principales coautores |
|-----|----------------|-------|
...
| **Economía de la cultura y consumo cultural** <br > (2008--) | Transición vía propiedad intelectual $\to$ participación cultural e industrias creativas y *big data* : *European Journal of Law and Economics* (2008) · *Journal of Cultural Economics* (2011, 2018) · *Poetics* (2020, 2025) · *Empirical Economics* (2023) | Manuel Cuadrado-García <br> María José Miquel-Romero <br> María Caballer-Tarazona <br> María Luisa Palma-Martos |



::: {.notes}
La tabla ordena las líneas de investigación, los trabajos representativos y los principales coautores. 
...
|:---:|:---:|:---:|
| 251 citas · h = 8 | 335 citas · h = 8 | 807 citas · h = 14 · i10 = 19 |
...
|----------|-------|----|:----:|
| **Live and prerecorded popular music consumption**  | *J. of Cultural Economics*, 2011 | JCR **Q2** (Economics) | 45 · 54 · 124 |
...
| **Analyzing online search patterns of music festival tourists**  | *Tourism Economics*, 2021 | JCR **Q1** (Economics) | 8 · 8 · 12 |
...
| **Assessing complementarities between live performances and YouTube video streaming**  | *Empirical Economics*, 2023 | JCR **Q2** (Economics) | 3 · 4 · 8 |
| **Arts and cultural consumption and diversity research: a bibliometric analysis**  | *Poetics*, 2025 | JCR **Q1** (Sociology) | 1 · 2 · 3 |
...
|--------|--------------|:-:|---|
| Sociedad Española de Radiodifusión (SER) | Organización y programación de un evento de música, cultura y ocio | 2012–13 | equipo |
| FECEMAC-CV | Indicadores de rendimiento y satisfacción en gestión de la educación musical | 2014–15 | equipo |
| Olympia Metropolitana | Actividades del centenario del Teatro Olympia | 2015–16 | equipo |
...
::: {.notes}
Un aspecto adicional de la dimensión investigadora son las estancias de investigación.
...
| *Estudio de los determinantes, percepción y valoración del consumidor de música clásica: una aproximación multidisciplinar* | Ariadna Martin-Alfaro  | Conservatorio Profesional de Música (Las Palmas de Gran Canaria) | en curso | JCR en revisión |
...
::: {.notes}
La tabla resume treinta años por etapas, con las asignaturas impartidas. En términos agregados la docencia se distribuye en siete centros, trece titulaciones y dieciocho asignaturas en castellano,  valenciano (acredito un nivel C1) e inglés (C2).
...
**17 cargos y tareas de gestión**, principalmente  en **internacionalización**
...
| **Gestión de la Internacionalización** | Gestión de las ayudas **EU-US ATLANTIS** (2011–2014) · Coordinador responsable del convenio con la *Zarb School of Business*, **Hofstra University** (Nueva York, 2014–2019) · Coordinación de los intercambios de dobles titulaciones (ADE-GEDE e International Business) |


: {tbl-colwidths="[22,78]"}

::: {.notes}
El liderazgo docente se constata en la **dirección proyectos**, ya mencionados, la **coodinación del título propio** de la Universitat (GEDE) y (a nivel del departamento) de la unidad docente de Estadística. Otras tareas incluye la elaboración de **guías docentes de grado y posgrado**. 
...
| **Evaluación científica** | **36 revisiones verificadas** para 15 revistas (percentil 91) · reconocimiento de *Poetics* (Q1) a la actividad evaluadora (2026) |
...
::: {.notes}
Antes de la síntesis final, recojo otros méritos, como son la actividad académica internacional, reflejada en conferencias y seminarios por invitación y la evaluación externa de tesis doctorales y trabajos de fin de máster.
...
## Síntesis: el currículum en cifras {background-color="#2D6A7A" .sintesis}


<!-- Figura pregenerada: scripts/fig_resumen_cv.py (cifras trazadas al CV en
     los comentarios del script; bloque «Impacto científico» con Scopus y WoS
     consultados el 12-09-2026, ver data/scopus_impact.md). Fondo teal
     solo en RevealJS (beamer ignora background-color en los frames), de ahí la
     figura oscura (--fondo-oscuro) para reveal y la clara para beamer; la
     clase .sintesis quita la regla coral del h2 en reveal (CSS del YAML). -->

::: {.content-visible when-format="revealjs"}

![](figures/fig_resumen_cv_fondo_oscuro.svg){width="96%"}

:::

::: {.content-visible when-format="beamer"}

![](figures/fig_resumen_cv.svg){width="96%"}

:::

::: {.notes}
Cierro con una síntesis del currículum. En la producción científica, más allá del volumen, su impacto: tres de cada cuatro artículos publicados en revistas del cuartil superior del área; 68% de las citas acumuladas a partir de 2021, con un impacto normalizado en 2025 un 32% por encima de lo esperado en el campo (situación que se repite en 5 de los últimos diez años);  uno de cada seis artículos se ubica en el decil superior por citas de su categoría (WoS). Una investigación reconocida con cuatro sexenios de investigación en el campo de Economía. 
