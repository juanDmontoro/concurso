...
|--------|------|
| Evolution and learning in collective decision-making (con J. Casas-Pardo y M. Puchades-Navarro) | Homenaje a J. M. Buchanan (*Methods and Moral in Constitutional Economics*) · **Springer**, 2001 |
| Empirical insights into recorded music consumer behavior and copyright infringement (con M. Cuadrado-García) | *Music and Law* · **Emerald**, 2013 |
| Regulator preferences and lobbying efforts in rent-seeking contest (autoría única) | *Constitutional Economics and Public Institutions* · **Edward Elgar**, 2013 |
| Copyright infringement and cultural participation (con M. Cuadrado-García y M. Puchades-Navarro) | *Digital Piracy: A Global, Multidisciplinary Account* · **Routledge**, 2018 |
| Breaking the gender gap in Rap/Hip-Hop consumption (con M. L. Palma-Martos y M. Cuadrado-García) | *Music as Intangible Cultural Heritage* · **Springer**, 2021 |
| Digital participation and audience enlargement in classical and popular music (con M. Cuadrado-García) | *Digital Transformation in the Cultural and Creative Industries* · **Routledge**, 2021 |
| Measuring customer multi-sensory experience in live music (con M. Cuadrado-García y C. E. Goyes-Yepez) | ***The Oxford Handbook of Arts and Cultural Management*** · **Oxford University Press**, 2022 |

Selección por editorial académica internacional; **29 capítulos y libros** en total, incluidos 4 casos docentes en el manual *Marketing Culture and the Arts* (HEC Montréal) y sus ediciones francesas.
...
| MBA-TABSA · Transatlantic Business School Alliance | Comisión Europea (EACEA) | 2010–2014 | IP (UV) |
...
| Entidad · objeto (participación)  | Años |
|--------|:-:|
...
16 contratos/convenios (art. 83 LOU / 60 LOSU) con el tejido cultural desde 2012 · IP en 6 · **Transferencia** reconocida con el **sexenio de transferencia** (2012–2017)
...
| --- | --- | --- |
| **Economía Política (1995)** | Economía Política y Hacienda Pública (Derecho, castellano y valenciano) · Economía (Lic. en CC. y Técnicas Estadísticas) · Estadística e Informática (CC. Empresariales) | Docencia impartida en Castellano y Valenciano |
...
| **Métodos Cuantitativos · Aprendizaje Estadístico (2019)** | Grado BIA: Datos No Estructurados, Técnicas Avanzadas de Predicción · Máster CD: Inferencia Causal y Aprendizaje Máquina, Ciencia de Datos en Negocio · Máster iMBA: Inteligencia de Negocios · Máster Economía: Big Data en Economía | Aumento de la presencia de docencia en máster |
...
| **Gestión de la internacionalización** en la Facultat d'Economia (cargos) | Coordinador del título Graduado Europeo en Dirección de Empresas (2010–2014) y de los intercambios de dobles titulaciones (ADE-GEDE $\to$ grado en International Business) |
| **Gestión de la internacionalización** en la Facultat d'Economia () | Representante de la Facultat d'Economia en la red TransAtlantic Business Schools Alliance (TABSA) · obtención y gestión de la ayuda EU-US ATLANTIS · responsable del convenio con Hofstra University (Nueva York) |
| **Gestión de la internacionalización** en la Universitat de València| Miembro de las comisiones de la Universitat: Comisión de Intercambio de Estudiantes de la UV (2010–2012) y Comisión de Relaciones Internacionales de la UV (2010–2014) · Comisión de Intercambio de la Facultat d'Economia (2010–2014) |
...
| --- | ------------ |
| **Grupo de investigación** | Grupo «Multi-aprendizaje, transversalidad y creatividad» — co-responsable; mención de grupo consolidado (2023, renovada 2026); continuidad del grupo «Innova multidisciplinar» (2009–2012). |
...
| **Miembro de la Comisión de Intecambio de Estudiantes**  | 2012--14 | Vicerrectorado de Relaciones Internacionales y Cooperación, Universitat de València: política de internacionalización |
...
| **Miembro de la CCA** del Máster en Ciencia de Datos |2021-- |  Escola Tècnica Superior d'Inginyeria:  posgrado en datos |
...
| | |
|----|--------|
| **Grupo de investigación** | **Dirección de CREAMARKT** (GIUV2020-47) desde 2022; grupo reconocido desde 2010; colaboraciones con HEC Montréal y el Institut für Kulturmanagement (Viena) |
...
| **Comités científicos** | Copresidencia del comité científico y presidencia de la sesión plenaria de apertura de **AIMAC 2007** (València); paneles de evaluación en 11 ediciones de AIMAC (2005–2026) · **I y II Workshop en Economía y Gestión de la Cultura** (Sevilla 2009 · València 2010) · **8th International Congress on Public and Nonprofit Marketing** (IAPNM 2009, València) |
...
| | |
|----|--------|
| **Proyectos docentes** | **IP de 4 proyectos docentes y de innovación**, incluido el europeo **MBA-TABSA**  |
| **Coordinación de titulación** | **Graduado Europeo en Dirección de Empresas** (2010–2014), cargo académico unipersonal; coordinación de los intercambios de dobles titulaciones (ADE-GEDE → International Business) |
| **Internacionalización** | Obtención y gestión de las ayudas **EU-US ATLANTIS** (2011–2014) · coordinador responsable del convenio con la Zarb School of Business, **Hofstra University** (Nueva York, 2014–2019) |
...
| **Evaluación externa** | Proyectos de tesis en **Télécom ParisTech** (2013), University f Applied Sciences Berlin (2015) y **Stockholm University** (2020) · dos TFM en Hannover University of Music, Drama and Media (2013) · Tesis en la Universitat de Girona (2022) |
