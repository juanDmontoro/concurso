...
\midrule
\textbf{Total} & \textbf{50 min} & \textbf{55} & \textbf{64} & \textbf{6664} & \textbf{47,6}\\
\bottomrule
\end{tabular}
...
3. Para responderla cada artista se ubica en un espacio construido a partir de las etiquetas que su público publica en redes. Bad Bunny y J Balvin tienen un vocabulario casi idéntico (proximidad); Taylor Swift y Kendrick Lamar apenas comparten palabras (distancia). 
