...
$\hat{g}$ selecciona controles por su capacidad de predecir $y$, no $D$ $\to$ **sesgo de regularización**.

Mismos datos para entrenar y predecir $\to$ **sesgo por sobreajuste**.
...
::: {.column width="58%"}
![](figures/fig_esquema_dml.svg){width="100%" fig-alt="Esquema: el enfoque ingenuo genera dos problemas, sesgo de regularización y sesgo de sobreajuste; sus soluciones, ortogonalización y cross-fitting, combinadas dan Double ML, estimador raíz de n consistente con inferencia válida"}
:::
