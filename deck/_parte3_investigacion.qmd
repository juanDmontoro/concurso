...
Cierro el ejercicio presentando la propuesta de investigación *Creative Collaborations*, cuyo objeto es el análisis de los factores asociados a la formación de colaboraciones en la producción cultural. Más concretamente,  y la pregunta que se formula es qué distingue a dos artistas que llegan a trabajar juntos de los muchos pares que podrían haberlo hecho.
...
::: {.notes}
La forma cuadrática de la similitud estética sitúa un máximo implícito en 0,64, que se ubica en el percentil 95 de la similitud observada: una zona con pocos eventos. En este caso la forma estimada es compatible tanto con 
...
::: {style="font-size:0.8em; color:#6c757d;"}
Curva: predicciones medias del logit con spline. Puntos: tasas ajustadas del logit por tramos, con intervalos de confianza diádicos.
:::
:::
...
El spline muestra un crecimiento marcado de la tasa de formación desde niveles bajos de similitud y una moderación posterior. Los puntos resumen las tasas por intervalos de similitud que no muestran un descenso claro a niveles altos (sí una mayor imprecisión). 
...
# Discusión y conclusiones {background-color="#2D6A7A"}
