...
:::{.callout-note icon="false"}
# ¿Por qué no un ERGM?  (Almquist y Butts, 2014)
...
Definidas respuesta y modelos, pasamos a las diferentes especificacioens. Para ello introducimos las variables en cuatro bloques:
...
::: {.notes}
Comenzamos analizando los resultados de la estimación base para el modelo de formación. La tabla muestra los coeficientes estimados para las diferentes especificaciones. Huiré del exceso de detalle y paso a analizar un subconjunto de los coeficientes estimados.
...
:::{.notes}
Los resultados muestran que el bloque de red es conjuntamente informativo (el contraste de wald rechaza el modelo restringido) y proximidad y centralidad se asocian a la formación de 
...
::: {.notes}
En el ejercicio predictivo se reestiman los dos modelos (logit y xgbm) con datos de 2015 a 2023 y se predice una sola vez en 2024, de modo que el modelo evaluado nunca ha visto el año de evaluación. En 2024 hay 64 eventos de formación de 490.000 (logit) o 526.000 díadas (xgbm) puntuadas según el modelo, una tasa base de 0,12 a 0,13 por mil. La diferencia viene porque el logit se entrena para el conjunto de casos completos y XGBoost para todos los pares, gracias al tratamiento nativo de los valores ausentes.
...
::: {.notes}
Dada la baja frecuencia del evento analizado, consideramos dos especificaciones alternativas: un modelo logit con corrección de Firth, que utiliza una verosimilitud penalizada para reducir el sesgo y mitigar posibles problemas de separación.
:::
